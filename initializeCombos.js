...
async function inicializarCombos() {
    try {
        ...
        console.log('Eliminando combos existentes...');
        ...
        console.log(`✅ Combos inicializados exitosamente! Se crearon ${combosCreados.length} combos:`);
        combosCreados.forEach(combo => {
            console.log(`- ${combo.nombre}: $${combo.precio}`);
        });
